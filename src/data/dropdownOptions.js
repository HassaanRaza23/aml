...
export const licenseTypes = [
  ...
  "Business License", "Certificate of Incorporation", "Virtual Asset License"
];

export const licenseCategories = [
  "Proprietory", "Partnership", "LLC", "FZC", "FZE", "Office of Foreign Company", "Offshore Companies", "Solo Establishment", "Public Limited Liability", "Private Limited Company", "DMCC", "FZ LLC", "Non profitable organization", "Civil Company"
];

export const jurisdictions = [
  "Main Land","Free Zone","Outsite UAE", "Offshore Company"
];
...
// Transaction form dropdown options
export const paymentModes = ["Cash Transaction", "Bank Transfer", "Exchange of Metal", "Card", "Cheque"];
export const transactionPurposes = [
    "Silver Manufacturing",
		...
		"Sale of Diamonds",
		"Export Purchase of Diamonds",
		"Import Purchase of Diamonds",
		"Purchase of Gold",
		"Sale of Scrap Gold",
		"Purchase of Scrap Gold",
		"Export Sale of Silver",
		"Import Purchase of Silver",
		"Export Sale of Gold",
		"Import  Purchase of Gold",
		"Sale of Silver",
		"Puchase of Silver",
		"Sale of Gold",
		"Used Cars",
		"Travel Agents and Services",
		"Trade Credits And Advance Receivable -TCR",
		"TRADE",
		"Tools, Hardware and Light Machinery",
		"Technical Trade-Related And Other Business Service",
...
export const executedByOptions = ["System", "User", "Manager", "Admin", "Automated"];
